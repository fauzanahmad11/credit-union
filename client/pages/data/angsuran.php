...
$queryAngsuran = "SELECT*FROM `view-angsuran` WHERE nokta='$id' AND status='aktif'";

if(isset($_GET['search'])){
    $queryAngsuran .= " AND notransaksi='{$_GET['search']}'";
}
...
$query = $library->conn->query("$queryAngsuran LIMIT $mulai,$halaman");
$data = $library->conn->query("$queryAngsuran");
