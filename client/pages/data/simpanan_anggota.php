...
$querySianggota = "SELECT * FROM `view-sianggota` WHERE nokta='$id'";

if(isset($_GET['search'])){
    $querySianggota .= " AND notransaksi='{$_GET['search']}'";
}
...
$query = $library->conn->query("$querySianggota LIMIT $mulai,$halaman");
$data = $library->conn->query("$querySianggota");
                                ...
                                <table class="tb_primary">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$control->rupiahSecound($row['dana'])?></td>
                                            <td><?=date("d-m-Y",strtotime($row['tgl_masuk']))?></td>
                                            <td><?=date("d-m-Y",strtotime($row['tgl_keluar']))?></td>
                                            <td><?=$row['bunga']*100?>%</td>
                                            <td><?=$control->rupiahSecound($row['totalbunga']+$row['dana'])?></td>
