...
$querySiwapo = "SELECT * FROM `view-siwapo` WHERE keterangan LIKE '%siwajib%' AND nokta='$id'";

if(isset($_GET['search'])){
    $querySiwapo .= " AND notransaksi='{$_GET['search']}'";
}
                                ...
                                <table class="tb_primary">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$control->rupiahSecound($row['subtotal'])?></td>
                                        </tr>
                                        <?php
                                            endif;
                                            endwhile;
                                        ...
                                        <tr style="font-weight:900;">
                                            ...
                                            <td><?=$control->rupiahSecound($saldo)?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
