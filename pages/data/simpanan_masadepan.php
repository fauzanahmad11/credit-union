...
$querySimapan = "SELECT*FROM `view-simapan`";
if(isset($_GET['search']) && !empty($_GET['search'])){
    $querySimapan .= " WHERE nokta LIKE '%{$_GET['search']}%'";
}else{
    $querySimapan = "SELECT SUM(nilai) AS saldo, COUNT(idsimapan) AS jumkartu,`view-simapan`.* FROM `view-simapan` WHERE status='aktif' GROUP BY `nokta`";
}
$query = $library->conn->query("$querySimapan LIMIT $mulai,$halaman");
$data = $library->conn->query("$querySimapan");
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="navbar-items">
                            ...
                            <ul class="navbar-list">
                                ...
                                <li class="list-item">
                                    <a href="../data/simpanan_masadepan.php" class="list-link active"><span>Simpanan Masa Depan</span></a>
                                </li>
                                <li class="list-item">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="display: flex; justify-content:center;">
                                                <a class="icon icon-cetak" target="_blank" href="../cetak/cetak_laporan.php?nokta=<?=$row['nokta']?>&key=simapan" title="Cetak data">
