...
$querySukarela = "SELECT*FROM `view-pinjaman` ";
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="navbar-items">
                            ...
                            <ul class="navbar-list">
                                ...
                                <li class="list-item">
                                    <a href="../data/pinjaman.php" class="list-link active"><span>Pinjaman</span></a>
                                </li>
                                <li class="list-item">
                                ...
                                <table class="tb_primary">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=date("d-m-Y",strtotime($row['tgl_mulai_a']))?></td>
                                            <td><?=date("d-m-Y",strtotime($row['tgl_selesai_a']))?></td>
                                            <td style="display: flex; justify-content:center;">
                                                <a class="icon icon-cetak" target="_blank" href="../cetak/cetak_laporan.php?nokta=<?=$row['nokta']?>&key=pinjaman" title="Cetak data">
