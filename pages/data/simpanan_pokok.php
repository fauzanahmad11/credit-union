...
$querySiwapo = "SELECT*FROM `view-siwapo` WHERE keterangan LIKE '%sipokok%'";

if(isset($_GET['search']) && !empty($_GET['search'])){
    $querySiwapo .= " AND nokta='".$_GET['search']."'";
}else{
    $querySiwapo = "SELECT sum(subtotal) AS saldo,`view-siwapo`.* FROM `view-siwapo` WHERE keterangan LIKE '%sipokok%' GROUP BY nokta";
}
...
if(isset($_POST['cetak'])){
    ...
    if(!empty($tglMulai) && !empty($tglSelesai)){
        ...
        document.location.href = 'simpanan_pokok.php';
        </script>";
}
?>
                ...
                <div class="navbar-content body">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="navbar-items">
                            ...
                            <ul class="navbar-list">
                                <li class="list-item">
                                    <a href="../data/simpanan_pokok.php" class="list-link active"><span>Simpanan Pokok</span></a>
                                </li>
                                <li class="list-item">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="display: flex; justify-content:center;">
                                                <a class="icon icon-cetak" target="_blank" href="../cetak/cetak_laporan.php?nokta=<?=$row['nokta']?>&key=sipokok" title="Cetak data">
