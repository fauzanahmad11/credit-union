                ...
                <div class="container">
                    ...
                    <div class="data-view">
                        <div class="table">
                            ...
                            <?php if((isset($_GET['search']) && empty($_GET['search'])) || !isset($_GET['search']) && empty($_GET['search'])){ ?>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="display: flex; justify-content:center;">
                                                <a class="icon icon-cetak" target="_blank" href="../cetak/cetak_laporan.php?nokta=<?=$row['nokta']?>&key=angsuran" title="Cetak data">
