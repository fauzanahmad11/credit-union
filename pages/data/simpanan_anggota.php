...
$querySukarela = "SELECT*FROM `view-sianggota` ";
if(isset($_GET['search']) && !empty($_GET['search'])){
    $querySukarela .= " WHERE nokta LIKE '%".$_GET['search']."%' OR notransaksi LIKE '%".$_GET['search']."%' OR nama LIKE '%".$_GET['search']."%'";
}
...
if(isset($_POST['cetak'])){
    ...
    if(!empty($tglMulai) && !empty($tglSelesai)){
        ...
        document.location.href = 'simpanan_anggota.php';
        </script>";
}   
?>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="navbar-items">
                            ...
                            <ul class="navbar-list">
                                ...
                                <li class="list-item">
                                    <a href="../data/simpanan_anggota.php" class="list-link active"><span>Simpanan Anggota</span></a>
                                </li>
                                <li class="list-item">
                                ...
                                <table class="tb_primary">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$row['nokta']?></td>
                                            <td><?=$control->limitkata($row['nama'],10)?></td>
                                            <td><?=$control->limitkata($row['namapetugas'],10)?></td>
                                            <td><?=$control->rupiah($row['dana'])?></td>
                                            <td><?=date("d-m-Y",strtotime($row['tgl_masuk']))?></td>
                                            <td><?=date("d-m-Y",strtotime($row['tgl_keluar']))?></td>
                                            <td><?=$row['bunga']*100?>%</td>
                                            <td><?=$control->rupiah($row['totalbunga']+$row['dana'])?></td>
                                            <td><?=ucwords($row['status'])?></td>
                                            <td style="display: flex; justify-content:center;">
                                                <a class="icon icon-cetak" target="_blank" href="../cetak/cetak_laporan.php?nokta=<?=$row['nokta']?>&key=sianggota" title="Cetak data">
