...
// Tampilkan data yang akan diupadate
...
if(isset($_POST['submit'])){
    ...
    $execute = $library->updateAnggota($data, $nama, $gender, $alamat, $noTelepon, $pekerjaan, $status);
}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="navbar-content body">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="navbar-items">
                            ...
                            <ul class="navbar-list">
                                <li class="list-item">
                                    <a href="add_anggota.php" class="list-link"><span>Tambah Anggota</span></a>
                                </li>
                                <li class="list-item">
                            ...
                            <form method="post">
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="noKta" class="form-control"
                                            placeholder="Example : Fauzan Ahmad" required readonly value="<?=$noKta?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="namaAnggota" class="form-label">Nama Anggota</label>
                                        <input type="text" name="namaAnggota" class="form-control"
                                            placeholder="Example : Fauzan Ahmad" required value="<?=$row['nama']?>">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="radio-control">
                                            <div class="box">
                                                <label for="gender" class="btn-radio">Laki-Laki
                                                    <input type="radio" <?php if($row['jenkel'] === 'laki-laki'){echo 'checked';} ?> name="gender" value="laki-laki" required>
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                            <div class="box">
                                                <label for="gender" class="btn-radio">Perempuan
                                                    <input type="radio" <?php if($row['jenkel'] === 'perempuan'){echo 'checked';} ?> name="gender" value="perempuan" required>
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        placeholder="Example : Jalan satu nomor dua rt/rw 1/2" required><?=$row['alamat']?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="pekerjaan" class="form-label">Pekerjaan</label>
                                        <input type="text" name="pekerjaan" class="form-control"
                                            placeholder="Example : Wirausaha" required value="<?=$row['pekerjaan']?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="noTelepon" class="form-label">No Telepon</label>
                                        <input type="number" name="noTelepon" class="form-control"
                                            placeholder="Example : 08229229XXXX" required value="<?=$row['notelepon']?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" required>
                                            ...
                                            <option <?php if($row['status'] === 'nonaktif'){ echo 'selected'; } ?>  
                                            value="nonaktif">Non Aktif</option>
