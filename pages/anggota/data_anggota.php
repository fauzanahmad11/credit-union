...
$query = $library->conn->query("SELECT*FROM anggota LIMIT $mulai,$halaman");
$data = $library->conn->query("SELECT*FROM anggota");
...
if(isset($_POST['cetak'])){
    ...
    if(!empty($tglMulai) && !empty($tglSelesai)){
        ...
        echo
        "<script>
        window.open('../cetak/cetak_anggota.php?start=$tglMulai&end=$tglSelesai');
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="navbar-items">
                            ...
                            <ul class="navbar-list">
                                ...
                                <li class="list-item">
                                    <a href="data_anggota.php" class="list-link active"><span>Data Anggota</span></a>
                                </li>
                            </ul>
                        </li>
                        <li class="navbar-items">
                    ...
                    <div class="data-view">
                        <div class="table">
                            <div class="table-head">
                                <h1>Data</h1>
                                <a href="add_anggota.php" class="link" title="data pinjaman">add new</a>
                            </div>
                                ...
                                <table class="tb_primary">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th><?=$no++?></th>
                                            <td><?=$row['nokta']?></td>
                                            <td><?=$control->limitkata($row['nama'],18)?></td>
                                            <td><?=$row['jenkel']?></td>
                                            <td><?=$control->limitkata($row['alamat'],20)?></td>
                                            <td><?=$row['notelepon']?></td>
                                            <td><?=$row['pekerjaan']?></td>
                                            <td>
                                            <?php
                                            ...
                                            <td style="display: flex; justify-content:center;">
                                                ...
                                                <a href="delete_anggota.php?data=<?=$control->hashMethod('encrypt',$row['nokta'])?>" class="icon icon-delete" title="hapus data"
                                                 onclick="return confirm('Menghapus data ini adalah menonaktifkan anggota. Yakin?');">
