...
<body>
    <table border="0">
        ...
        <tr>
            <th class="b-t-s" colspan="5" width="500" height="150"><center><h1>KWITANSI MASUK</h1></center></th>
        </tr>
        <tr>
        ...
        if($row['namatransaksi'] == "angsuran pokok"){
            $html .= '
            <tr>
            <td></td>
            <td width="200">- Angsuran Pokok</td>
            <td colspan="3">'.$control->rupiah($row['total']).'</td>
            </tr>
            ';
        }
        if($row['namatransaksi'] == "angsuran bunga"){
            $html .= '
            <tr>
            <td></td>
    ...
    endwhile;
        ...
        <td colspan="3"><b class="b-b-s">'.$control->rupiah($totalTransaksi['total']).'</b></td>
        </tr>
        ';
        ...
        $html .= '
        <tr>
        <td colspan="5" class="b-s" height="50"><b>Terbilang : </b> '. ucwords($control->terbilang($totalTransaksi['total'])) .' Rupiah</td>
        </tr>
        ';
