...
if(isset($_POST['submit'])){
    $id              = $idpetugas;
    $passwordLama = htmlspecialchars(strtolower(($_POST['passwordLama'])));
    $passwordBaru = htmlspecialchars(strtolower(($_POST['passwordBaru'])));
    $konfirmasiPassword = htmlspecialchars(strtolower(($_POST['konfirmasiPassword'])));
    
    $execute = $library->changePassword($id, $passwordLama, $passwordBaru, $konfirmasiPassword);
}
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="passwordLama" class="form-control"
                                            placeholder="Enter your latest password" required autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="konfirmasiPassword" class="form-control"
                                            placeholder="Confirm your new password" required autocomplete="off">
                                    </div>
                                    <div class="btn-group">
